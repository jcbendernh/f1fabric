...
Once these are downloaded and extracted on your local machine, you will need to upload the .csv files to your Lakehouse within Fabric so that they can be utilized by the Fabric Notebooks in the next section.
